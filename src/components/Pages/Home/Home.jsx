...
export default function Home() {
    ...
    const filteredProperties = properties.filter((property) => {
            ...
            const matchesBathrooms = bathrooms === "All" || property.bathrooms === Number(bathrooms);
    
            return (matchesLocation && matchesRent && matchesHomeType && matchesBedrooms && matchesBathrooms);
        });
